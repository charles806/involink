      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        >
          <h1 className="text-5xl lg:text-6xl font-bold mb-6">
            <span className="text-emerald-600">Legal</span> Center
          </h1>
          ...
          <div className="space-y-6">
            {legalDocs.map((doc, i) => (
              ...
              >
                <Link
                  to={doc.link}
                  className="block p-8 rounded-2xl bg-card border border-border shadow-e2 hover:border-emerald-500/30 transition-all duration-300 group"
                >
                  <div className="flex items-start gap-6">
                    <div className="w-16 h-16 rounded-2xl bg-emerald-500/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                      <doc.icon className="w-8 h-8 text-emerald-600" />
                    </div>
                    <div className="flex-1">
                      <h2 className="text-2xl font-semibold mb-2 group-hover:text-emerald-600 transition-colors">
                        {doc.title}
                      </h2>
