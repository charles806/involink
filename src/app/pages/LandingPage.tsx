...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
      scrolled ? "bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800 shadow-sm" : "bg-transparent"
    }`}>
        ...
        {isOpen && (
          ...
          >
            <div className="space-y-3">
              ...
              <Link to="/login" className="block py-2 text-gray-700 dark:text-gray-200 font-medium">
                Log In
              </Link>
              <Link to="/signup" className="block py-3 text-center rounded-xl font-medium bg-emerald-500 text-white">
                Start Free
              </Link>
            </div>
          </motion.div>
...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Create invoices. <span className="text-emerald-600">Get paid.</span>
              <br />
            ...
            >
              Send professional invoices in Naira, track payments in real-time, and get paid faster. 
              No complex apps, no foreign integrations.
            </motion.p>
          ...
          >
            <TiltCard className="relative">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700 transform transition-transform" style={{ transformStyle: "preserve-3d" }}>
                <motion.div 
                ...
                <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-100 dark:border-gray-700">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">INV-0001</p>
                  </div>
                ...
                <div className="flex justify-between pt-4 border-t-2 border-emerald-500">
                  ...
                  <span className="font-bold text-2xl text-emerald-600">₦400,000</span>
                </div>
...
const InteractiveFeatureCard = ({ icon: Icon, title, description, features, color = "emerald", delay = 0 }: { icon: any, title: string, description: string, features: string[], color?:string, delay?: number }) => {
  const ref = useRef(null);
  ...
  return (
    ...
    >
      <div className={`absolute inset-0 bg-gradient-to-br ${colorMap[color]} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
  ...
  const featureGroups = [
    {
      ...
      features: ["Custom invoice numbers", "Line items + discounts", "VAT/tax support", "Your branding"],
      color: "emerald"
    },
    {
      icon: Send,
      ...
      features: ["Email delivery", "WhatsApp sharing", "Payment links", "PDF export"],
      color: "blue"
    },
    {
      icon: Wallet,
      ...
      features: ["Real-time status", "Payment reminders", "Auto-receipts", "Bank transfer tracking"],
      color: "purple"
    },
    {
      icon: BarChart3,
      ...
      features: ["Revenue reports", "Outstanding totals", "Client history", "Export to Excel"],
      color: "amber"
    },
  ];
  
  return (
    <section id="features" className="py-24 bg-gray-50 dark:bg-gray-900/50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Powerful features, no complexity. Just what Nigerian entrepreneurs need to get paid.
            </p>
          </div>
        </ScrollReveal>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              We get it. Foreign apps don't always work here. We built Involink specifically for Nigerian entrepreneurs.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <ScrollReveal delay={0}>
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">₦Naira-First</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Built from the ground up for Naira. No currency confusion — ₦150,000 is exactly ₦150,000.
              </p>
            </motion.div>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Simple Payments</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Bank transfers, payment links that work with Nigerian banks. No Stripe, no PayPal needed.
              </p>
            </motion.div>
          </ScrollReveal>
          <ScrollReveal delay={0.2}>
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Fast Setup</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Sign up, add client, send invoice — done in 2 minutes. No credit card to start.
              </p>
            </motion.div>
          </ScrollReveal>
        </div>
            ...
            <ScrollReveal key={i} delay={i * 0.1}>
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  {plan.period && <span className={`text-sm ${plan.highlighted ? 'text-emerald-100' : 'text-gray-500'}`}>{plan.period}</span>}
                </div>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, j) => (
                    <li key={j} className="flex items-center gap-2 text-sm">
                      ...
                      <span className={plan.highlighted ? 'text-white/90' : 'text-gray-600 dark:text-gray-300'}>{feature}</span>
                    </li>
                  ))}
                </ul>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-100 text-xl mb-8 max-w-xl mx-auto">
                Join Nigerian entrepreneurs who use Involink to create professional invoices and track payments.
              </p>
              <motion.div
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Nigeria's simplest invoicing platform. Create professional invoices, send to clients, and track payments — all in Naira.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li><Link to="/about" className="hover:text-emerald-500">About</Link></li>
              <li><Link to="/contact" className="hover:text-emerald-500">Contact</Link></li>
              <li><Link to="/privacy" className="hover:text-emerald-500">Privacy</Link></li>
            </ul>
          </div>
        </div>
